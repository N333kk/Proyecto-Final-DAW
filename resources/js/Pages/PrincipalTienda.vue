                ...
                <main class="mt-6">
                    <div class="min-h-screen min-w-screen flex flex-col items-center justify-center">
                        ...
                        <p class="mt-4 text-center text-lg text-black dark:text-white/70">
                            Bienvenido a la tienda de articulos, aqui podras encontrar los articulos mas recientes.
                        </p>
                        <ul class="p-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <li class="bg-white p-6 rounded-lg shadow-md flex text-black" v-for="articulo in articulos" :key="articulo.id">
                                <div class="flex-shrink-0 p-1">
                                    <img class="w-24 h-36 object-cover rounded" :src="`${articulo.image}`" alt="Imagen articulo">
                                </div>
                                <div class="ml-4">
