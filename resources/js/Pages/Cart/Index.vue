            ...
            <div class="flex flex-col md:flex-row w-full min-h-screen">
                ...
                <div
                    ...
                    <div v-if="localCartItems.length > 0" class="space-y-4">
                        ...
                        <div v-for="item in localCartItems" :key="item.id" @click="seleccionarArticulo(item)"
                            ...
                            :class="selectedItem &&
                                    ...
                                    selectedItem.talla_id === item.talla_id
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <p class="text-2xl font-extrabold text-purple-700 dark:text-purple-400">
                                    {{ precioTotal }} €
                                </p>
                            </div>
                    ...
                    <div v-else
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-16 h-16 text-gray-400 dark:text-gray-500 mb-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                        </svg>
                        ...
                        <p class="text-center text-sm text-gray-500 dark:text-gray-500 mb-4">
                ...
                <div class="w-full md:w-3/5 p-4 md:p-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="w-full md:w-1/2 relative">
                                ...
                                <Carousel
                                    ...
                                    :items-to-show="1" :wrap-around="true" :autoplay="3000" v-if="
                                        selectedItem.articulo.imagenes &&
                                        selectedItem.articulo.imagenes.length >
                                        0
                                    ">
                                    <Slide v-for="(imagen, index) in selectedItem
                                        .articulo.imagenes" :key="index">
                                        <div class="h-64 md:h-80 flex items-center justify-center p-4">
                                            <img :src="isFullUrl(imagen.ruta)
                                                    ? imagen.ruta
                                                    : `/storage/${imagen.ruta}`
                                ...
                                <div v-else
                                    ...
                                    <img src="/img/placeholder.webp" alt="Imagen no disponible"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2 mb-6">
                                    ...
                                    " class="flex flex-col">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span class="line-through text-gray-500 dark:text-gray-400 text-lg">{{
                                    ...
                                    <span
                                        class="px-2 py-1 bg-green-50 text-green-600 dark:bg-green-100/20 dark:text-green-400 text-xs font-semibold rounded-full border border-green-200 dark:border-green-400/30">En
                                        stock</span>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-gray-600 dark:text-white/60 text-sm">Subtotal:
                    ...
                    <div v-else
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-16 h-16 text-purple-300 dark:text-purple-300/40 mb-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                        </svg>
