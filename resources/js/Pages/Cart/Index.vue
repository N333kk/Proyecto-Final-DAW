        ...
        <div v-if="cartItems.length > 0">
          <div class="bg-white py-2 px-4 rounded-2xl shadow-md flex text-black m-4 transition-all hover:bg-white/90"
            ...
            <div class="flex-shrink-0 p-1 flex flex-col items-center justify-center ml-2">
              <img class="w-12 h-12 object-cover rounded-full" :src="`${item.articulo.imagen}`" alt="Imagen Articulo">
          ...
          <Link :href="`/pedidos/`" method="POST"
            class="bg-black hover:bg-white hover:text-black hover:border-black transition-all border-white border text-white font-bold py-2 px-4 rounded mt-2  mx-1 inline-block">
