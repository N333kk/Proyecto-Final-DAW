                ...
                <main class="w-full">
                    ...
                    <div class="bg-gradient-to-b from-black/90 to-gray-900 text-white py-16 px-4">
                        <div class="container mx-auto text-center max-w-4xl">
                            ...
                            <template v-else>
                                <h1 class="text-5xl font-bold mb-4">Bienvenido a Caveman!</h1>
                            </template>
                    ...
                    <!-- Productos destacados con artículos reales -->
                                        ...
                                        <div class="mt-4 flex justify-between">
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                <template v-if="$page.props.auth.user && $page.props.auth.user.rol === 'admin'">
                                                    <Link :href="`/articulos/${articulo.id}/edit`" class="text-blue-600 dark:text-blue-400 hover:text-blue-800">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                                        </svg>
                                                    </Link>
                                                    <Link :href="`/articulos/${articulo.id}`" method="delete" as="button" class="text-red-600 dark:text-red-400 hover:text-red-800" 
                                                ...
                                                <button @click="addToCart(articulo.id)"
                                                    class="bg-black text-white dark:bg-white dark:text-black px-3 py-1 rounded-md hover:bg-gray-800 dark:hover:bg-gray-200">
                                                    Añadir
                                                </button>
                                            </div>
                                        </div>
