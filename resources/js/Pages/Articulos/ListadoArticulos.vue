                            ...
                            <div class="w-full pointer-events-auto">
                                ...
                                <div v-if="!$page.props.auth.user" class="w-full">
                                    <Link :href="`/articulos/${articulo.id}`"
                                        class="w-full bg-white hover:bg-gray-100 dark:bg-white dark:hover:bg-gray-100 text-gray-800 dark:text-black font-semibold py-2 px-4 rounded-md transition-colors flex items-center justify-center gap-2 shadow-sm">
